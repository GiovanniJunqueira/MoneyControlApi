...
public class CategoryService {
    ...
    public CategoryService(CategoryRepository categoryRepository, ExpenseRepository expenseRepository, UserRepository userRepository) {
    ...
    public CategoryResponse create(CategoryRequest request) {
        categoryRepository.findByUserIdAndName(CurrentUser.id(), request.name())
                .ifPresent(c -> { throw new AppException("Você já tem uma categoria com esse nome.", HttpStatus.CONFLICT); });
